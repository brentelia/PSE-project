            ...
            case CFR_WORD_1:
                if((sum.read() & 3) == 0) 
                    val1.write(val1.read()+((((val2.read() << 4) ^ (val2.read() >> 5)) +
                         val2.read()) ^ (sum.read() + k1.read())));
                else if((sum.read() & 3) == 1) 
                    val1.write(val1.read()+(((((val2.read() << 4) ^ (val2.read() >> 5)) +
                         val2.read()) ^ (sum.read() + k2.read()))));
                else if ((sum.read() & 3) == 2)
                    val1.write(val1.read()+((((val2.read() << 4) ^ (val2.read() >> 5)) +
                         val2.read()) ^ (sum.read() + k3.read())));
                else val1.write(val1.read()+((((val2.read() << 4) ^ (val2.read() >> 5)) +
                         val2.read()) ^ (sum.read() + k4.read())));
                sum.write(sum.read()+delta.read());
                break;
            case CFR_WORD_2:
                if((sum.read()>>11 & 3) == 0) 
                    val2.write(val2.read()+((((val1.read() << 4) ^ (val1.read() >> 5)) +
                         val1.read()) ^ (sum.read() + k1.read())));
                else if((sum.read()>>11 & 3) == 1) 
                    val2.write(val2.read()+(((((val1.read() << 4) ^ (val1.read() >> 5)) +
                         val1.read()) ^ (sum.read() + k2.read()))));
                else if ((sum.read()>>11 & 3) == 2)
                    val2.write(val2.read()+((((val1.read() << 4) ^ (val1.read() >> 5)) +
                         val1.read()) ^ (sum.read() + k3.read())));
                else val2.write(val2.read()+((((val1.read() << 4) ^ (val1.read() >> 5)) +
                         val1.read()) ^ (sum.read() + k4.read())));
